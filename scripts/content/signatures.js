...
//
// This keeps per-run universe identity in data space instead of burying it
// separately in browser runtime modules and seeded-generation mirrors.
...
const SIGNATURE_POOLS_BY_MAP_SIZE = {
