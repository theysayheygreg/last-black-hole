...
function statusService(name) {
  if (name === 'dev') return runNodeSafe('dev-server.cjs', 'status');
  if (name === 'sim') return runNodeSafe('sim-server.cjs', 'status');
  if (name === 'control') return runNodeSafe('control-plane-server.cjs', 'status');
  return '';
}
...
function stopService(name) {
  if (name === 'dev') return runNodeSafe('dev-server.cjs', 'stop');
  if (name === 'sim') return runNodeSafe('sim-server.cjs', 'stop');
  if (name === 'control') return runNodeSafe('control-plane-server.cjs', 'stop');
  return '';
}
