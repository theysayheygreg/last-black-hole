...
async function run() {
  ...
  const fixtures = [
    ...
    },
    {
      ...
      expected: {
        player: {
          wx: 1.733697890367381,
          wy: 1.5201721105310773,
          vx: -0.06275577004166666,
          vy: 0,
          deltaV: 14.239999999999963,
          timeSinceThrust: 0,
        },
        lastStep: {
          thrustIntensity: 0,
    ...
    },
    {
      ...
      expected: {
        player: {
          wx: 1.3020528026045266,
          wy: 1.484986214558326,
          vx: 0.35340281201527574,
          vy: 0.5985247542650075,
          deltaV: 40.85080580767283,
          timeSinceThrust: 0,
        },
        lastStep: {
