...
async function run() {
  ...
  includes(index, "id=\"hud-hull-bar\" role=\"progressbar\"", "Deck HUD must expose hull state");
  includes(index, "id=\"hud-noise-readout\"", "Deck HUD must expose Noise state alongside hull");
