const SUITES = [
  {
    name: "ManifestCompleteness",
    file: "manifest-completeness.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "JourneyRuntime",
    file: "journey-runtime.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "JourneyDefinitions",
    file: "journey-definitions.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "JourneyConditionProjection",
    file: "journey-condition-projection.cjs",
    lanes: ["core", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "JourneyDriverContract",
    file: "journey-driver-contract.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "JourneyLegacyAbsence",
    file: "journey-legacy-absence.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
  ...
  {
    name: "ConditionConsumers",
    file: "condition-consumers.cjs",
    lanes: ["core", "static", "full"],
    browser: false,
  },
  {
    name: "MovementAffordances",
    file: "movement-affordances.cjs",
    lanes: ["fast", "core", "static", "authority", "full"],
    browser: false,
  },
  {
    name: "MovementInputPath",
    file: "movement-input-path.cjs",
    lanes: ["core", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "MovementApproachSmoke",
    file: "movement-approach-smoke.cjs",
  ...
  {
    name: "SimHostRetention",
    file: "sim-host-retention.cjs",
    lanes: ["authority", "full"],
    browser: false,
    slow: true,
  },
  ...
  {
    name: "JourneyRepresentative",
    file: "journey-representative.cjs",
  ...
  {
    name: "ContinuousFreeContributions",
    file: "continuous-free-contributions.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "CoordinatePresentationSeams",
    file: "coordinate-presentation-seams.cjs",
    lanes: ["fast", "core", "static", "three", "full"],
    browser: false,
  },
  {
    name: "EntityPresentationScale",
    file: "entity-presentation-scale.cjs",
    lanes: ["fast", "core", "static", "three", "full"],
    browser: false,
  },
  {
    name: "FabricLanes",
    file: "fabric-lanes.cjs",
    lanes: ["fast", "core", "static", "three", "full"],
    browser: false,
  },
  {
    name: "FabricProfile",
    file: "fabric-profile.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "FabricReadabilityCleanup",
    file: "fabric-readability-cleanup.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "FabricSimplification",
    file: "fabric-simplification.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "FabricWaveV4",
    file: "fabric-wave-v4.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "FabricWaveV5",
    file: "fabric-wave-v5.cjs",
    lanes: ["fast", "core", "static", "three", "full"],
    browser: false,
  },
  {
    name: "FabricWellPresentation",
    file: "fabric-well-presentation.cjs",
    lanes: ["fast", "core", "static", "three", "full"],
    browser: false,
  },
  {
    name: "FreeMovementStep",
    file: "free-movement-step.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "HonestEnvironmentChannels",
    file: "honest-environment-channels.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "InhibitorCapRunReset",
    file: "inhibitor-cap-run-reset.cjs",
    lanes: ["authority", "sim-structure", "full"],
    browser: false,
    isolationGroup: "fixed-services",
  },
  {
    name: "InhibitorEcology",
    file: "inhibitor-ecology.cjs",
    lanes: ["authority", "sim-structure", "full"],
    browser: false,
    isolationGroup: "fixed-services",
  },
  {
    name: "InteractionVolumes",
    file: "interaction-volumes.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "NoiseRadius",
    file: "noise-radius.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "OrreryRouteTeaching",
    file: "orrery-route-teaching.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "GlobalMute",
    file: "global-mute.cjs",
    lanes: ["playtest", "full"],
    browser: true,
    slow: true,
  },
  {
    name: "PresentationEvidence",
    file: "presentation-evidence.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "SlingshotInputFeedback",
    file: "slingshot-input-feedback.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "StarSolarWindParity",
    file: "star-solar-wind-parity.cjs",
    lanes: ["fast", "core", "static", "authority", "sim-structure", "full"],
    browser: false,
  },
  {
    name: "TimeSlowRetirement",
    file: "time-slow-retirement.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "UiMotionTemporal",
    file: "ui-motion-temporal.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
    name: "UiMotionTimeline",
    file: "ui-motion-timeline.cjs",
    lanes: ["fast", "core", "static", "full"],
    browser: false,
  },
  {
