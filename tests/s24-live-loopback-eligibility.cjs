...
assert.strictEqual(result.rawArtifactPresent, false);
assert.strictEqual(result.runConsumption.operatorReported, "not-launched");
assert.strictEqual(result.runConsumption.machineVerifiableFromRepository, false);
