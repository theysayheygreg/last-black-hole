...
> is preserved from `docs/design/SIGNAL-DESIGN.md`; it is an idea mine, not
> the living v0.3 signal spec. Superseded for current ownership by
> [`docs/v0.3/DESIGN-INDEX.md#signal`](../../v0.3/DESIGN-INDEX.md#signal),
> S10 in the v0.3.1 design review, and `docs/v0.3/OPEN-DECISIONS.md`.
