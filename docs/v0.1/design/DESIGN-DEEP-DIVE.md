> **Historical v0.1 design document.** Frozen on 2026-07-15. The body below
> is preserved from `docs/design/DESIGN-DEEP-DIVE.md`; it is an idea mine, not
> the living v0.3 architecture/design contract. Superseded for current
> ownership by [`docs/v0.3/README.md`](../../v0.3/README.md),
> [`docs/v0.3/DESIGN-INDEX.md`](../../v0.3/DESIGN-INDEX.md), and the active
> v0.3 roadmap and review sources.

# Last Singularity — Design Deep Dive
...
> For ship physics model, input schemes, and per-device tuning, see [CONTROLS.md](../../design/CONTROLS.md). For tuning workflow and dev panel, see [TUNING.md](../../design/TUNING.md). For automated test harness, see [AGENT-TESTING.md](../../design/AGENT-TESTING.md).
