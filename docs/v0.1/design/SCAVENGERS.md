...
> is preserved from `docs/design/SCAVENGERS.md`; it is an idea mine, not the
> living v0.3 hostile-AI spec. Superseded for current ownership by
> [`docs/v0.3/DESIGN-INDEX.md#scavengers`](../../v0.3/DESIGN-INDEX.md#scavengers)
> and S13 in the v0.3.1 design review.
