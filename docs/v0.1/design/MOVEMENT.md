...
> is preserved from `docs/design/MOVEMENT.md`; it is an idea mine, not the
> living v0.3 movement spec. Superseded for current ownership by
> [`docs/v0.3/DESIGN-INDEX.md#movement`](../../v0.3/DESIGN-INDEX.md#movement),
> S5 and the v0.3.1 velocity ledger.
...
> **Ship physics model, input schemes, and per-device tuning have moved to [CONTROLS.md](../../design/CONTROLS.md).**
...
> Full ship control tuning table is in [CONTROLS.md](../../design/CONTROLS.md#ship-control-tuning-variables).
