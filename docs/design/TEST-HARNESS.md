...
| `multiplayer-playable` | real 4p twice / 8p once browser journey, owner privacy, physical action edges, exact-once reconnect, steady application bytes, 1280x800 evidence, and process cleanup | WAN, TLS edge, hosted capacity, Greg taste, or public readiness |
