...
into a coherent human multiplayer game. Crew Muster plus the first private
room/readiness slice are live. The immediate slice is a focused four-browser
host/join/readiness/launch/reconnect journey, followed by invite-copy/error
polish and shared-run readability. See
