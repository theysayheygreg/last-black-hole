...
| Consumables, pulse, shield, breach flare | `player.effectUsed`, absorb, `player.pulse` | Action identity must outrank spectacle. Pulse gets brief world duck and body; shields are glass/field; breach flare gets a short tear. |
