...
10. `../design/PILLARS.md` and `../design/MOVEMENT.md` - design guardrails.
11. `../design/TEST-HARNESS.md` - current harness contract.
12. `../v0.2/ROADMAP.md` - active demo/stabilization roadmap.
