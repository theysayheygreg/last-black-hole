> **Historical v0.2 design document.** Frozen on 2026-07-15. The body below
> is preserved from `docs/design/SLINGSHOT-NETWORK.md`; it is an idea mine,
> not the living v0.3.1 slingshot spec. Superseded for current ownership by
> [`docs/v0.3/DESIGN-INDEX.md#slingshot`](../../../v0.3/DESIGN-INDEX.md#slingshot),
> S4 in the v0.3.1 design review, and the W1-D completion record.
