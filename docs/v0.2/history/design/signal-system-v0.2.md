> Archive metadata: frozen v0.2 body. The substantive text below is preserved
> mechanically from `docs/design/SIGNAL-SYSTEM.md` at the v0.3 versioning
> boundary. It is historical context, not a live v0.3 specification.
