...
export const CUE_SPECS = Object.freeze({
  ...
  shieldActivate: spec('shieldActivate', { bus: 'player', priority: 'action', duration: 0.5 }),
  ...
  scavDeath: spec('scavDeath', { bus: 'world', priority: 'warning', maxVoices: 2, duration: 0.55, spatial: true }),
  ...
  inhibitorFinalPortal: spec('inhibitorFinalPortal', { bus: 'critical', priority: 'critical', duration: 1.3, cooldown: 0.5, motif: 'magenta-inhibitor' }),
  menuMove: spec('menuMove', { bus: 'ui', priority: 'ui', duration: 0.12, cooldown: 0.05, motif: 'route-cell' }),
  menuConfirm: spec('menuConfirm', { bus: 'ui', priority: 'ui', duration: 0.18, cooldown: 0.08, motif: 'route-cell' }),
  ...
  upgrade: spec('upgrade', { bus: 'ui', priority: 'ui', duration: 0.5 }),
