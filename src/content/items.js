// Client item manifest mirror.
//
// Keep this in sync with scripts/content/items.js so client seed previews and
// local loot generation use the same catalog as the authoritative sim.
